...
class ConceptsPrediction:
    ...
    def predict_category(self, test_data_tokens, nlp):
        ...
        filepath_encoder_category = os.path.abspath(
            os.path.join(dirname, "data", "trained_models", "encoder_category.pickle")
        )
        filepath_encoder_type = os.path.abspath(
            os.path.join(dirname, "data", "trained_models", "encoder_type.pickle")
        )
...
if __name__ == "__main__":
    ...
    print("For concept User ",
          predictor.predict_category([ "email"], nlp))
