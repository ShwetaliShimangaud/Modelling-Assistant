...
def parse_domain_model(xml_file_path, domain_name):
    # Parse the XML file
    ...
    log_file_path = f"{results_dir}//predictions//{domain_name}//domain_logs2.txt"

    with timer("Model slicing", log_file_path):
        print("\nTypes:")
